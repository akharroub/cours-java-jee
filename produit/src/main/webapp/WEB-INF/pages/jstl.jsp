...
<body>
	...
	<c:choose>
		...
		<c:otherwise>
			<p>toutes les condition sont fausse</p>
		</c:otherwise>
	</c:choose>

	<p>addition 12 et 14 => ${12 + 14 }</p>
	<p>soustraction 12 et 14 => ${12 - 14 }</p>
	<p>multiplication 12 et 14 => ${12 * 14 }</p>
	<p>divition 12 et 14 => ${12 / 14 }</p>
